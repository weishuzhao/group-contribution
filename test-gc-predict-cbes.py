...
cid_mapping = {}
for row in csv.reader(open('../data_prep/final_input_data/cpdid_GCdb.tsv', mode='rU'), delimiter='\t'):
...
wp2_structure = {}
for row in csv.reader(open('../data_prep/final_input_data/cpdid_smiles.tsv', mode='rU'), delimiter='\t'):
	wp2_structure[row[0]] = row[1]
# print(wp2_structure)


mr = ModelReader.reader_from_path('/Users/kzhang/Projects/Caldi/Cbescii/GEM-iCbes/New_Cbes_GEM/model.yaml')
nm = mr.create_model()
